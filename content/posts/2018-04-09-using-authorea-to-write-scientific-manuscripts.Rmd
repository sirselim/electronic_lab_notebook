...
We've already written a small entry on [Authorea](https://www.authorea.com) and it's use for collaborative scientific writing. Here I'll list a few of the major benefits/features that make it a perfect tool for collaborative writing which facilitates reproducibility.
...
## Benefits of Authorea (in no particular order)
  ...
  - data can be hosted and associated with the document (truly open access)
  ...
  - seamless mathematical equation support and rendering
  ...
  - **ability to host code and data along with the figures and text is a great move towards reproducibility and transparency**
